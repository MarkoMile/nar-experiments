# Training entry point for the BFS task.
#
...
#
# Usage:
#   python -m src.experiments.train_bfs --cfg src/configs/bfs/bestmodel.yml --enable-wandb
...
# Re-export for backward compatibility (tests and other scripts may import these)
from src.experiments.train import train, EpochProfilingCallback  # noqa: F401
