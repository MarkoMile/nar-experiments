"""
Dataset loading utilities for SALSA-CLRS algorithms.

Provides `get_dataset()` which reads the project config and returns
the appropriate SALSA-CLRS dataset(s) for a given split.
"""
...
# Apply all SALSA-CLRS monkey-patches on import (sparseness, torch.load,
# extended graph generators, sampler registration).
import src.utils.patches  # noqa: F401  — side-effect import

# Re-export patched_create_graph for backward compatibility with tests
